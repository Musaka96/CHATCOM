    ...
    <div>
      ...
      <section className="relative overflow-hidden border-b border-white/5">
        <div className="absolute inset-0">
          ...
          />
          <div
            className="absolute inset-y-0 left-0 w-full max-w-4xl"
            style={{
              background:
                "linear-gradient(to right, var(--background) 0%, var(--background) 55%, transparent 100%)",
            }}
          />
        </div>
        <div className="relative z-10 mx-auto flex min-h-[640px] max-w-6xl items-center px-4 py-14 sm:px-6">
          <div
            ...
            style={{
              textShadow:
                "0 0 30px rgba(0,0,0,1), 0 0 60px rgba(0,0,0,1), 0 4px 20px rgba(0,0,0,1), 0 2px 8px rgba(0,0,0,1)",
            }}
          >
        ...
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            ...
            >
              ...
              <p className="mt-2 text-sm text-muted">
                Bulk-build a whole page of cards in one pass with Quick Page
                Maker, drag cards between pages and windows, give any card
                its own keyboard shortcut, then export a single page to
                share with another chatter without handing over your whole
                setup.
              </p>
              <span className="mt-4 inline-block text-sm font-semibold text-accent-soft transition group-hover:translate-x-1">
                See how it works →
